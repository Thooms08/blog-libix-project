...
if (empty($posts)): ?>
    ...
    <div class="bg-cyber-card border border-cyber-border rounded-2xl px-5 py-16 text-center">
        ...
        <p class="text-cyber-muted font-semibold text-base mb-1">Belum ada artikel</p>
                        ...
                        <div class="w-10 h-10 rounded-lg overflow-hidden flex-shrink-0 bg-cyber-panel border border-cyber-border">
                            <?php if ($imgSrc): ?>
                                <img src="<?= $imgSrc ?>" alt="" class="w-full h-full object-cover" loading="lazy"
                                     onerror="this.parentElement.innerHTML='<div class=\'w-full h-full flex items-center justify-center\'><i class=\'devicon-markdown-original text-cyber-dim text-xl\'></i></div>'">
                            <?php else: ?>
                                <div class="w-full h-full flex items-center justify-center">
                                    <i class="devicon-markdown-original text-cyber-dim text-xl"></i>
                                </div>
                            <?php endif; ?>
                        </div>
                        <div class="min-w-0">
